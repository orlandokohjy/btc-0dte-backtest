...
for i, (alloc, (sizing_label, is_flat), (tp_tag, tp_on)) in enumerate(combos, 1):
    ...
    folder = f"0dte_bybit10k_s3_10x_{alloc_label}_{sizing_label}{tp_file_tag}_output"
...
# Save summary
out_csv = _SCRIPT_DIR / "output" / "bybit10k_spot_sweep_results.csv"
keys = results[0].keys()
...
print("\n" + "=" * 110)
print("BYBIT SPOT 10x SWEEP — S3 SESSION — 0.5 BTC + 2 PUTS — $10K START")
print("=" * 110)
